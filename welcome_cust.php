...
<html lang="en">
  ...
  <div class="card-body my-2">
    <h5 class="card-title">View and Book cars</h5>
    <p class="card-text">View the cars available and book them.</p>
    <a href="view_bookcar.php" class="btn btn-primary">View/Book cars</a>
  </div>
</div>
</div>
...
<div class="col-md-4">
  ...
  <div class="card-body my-2">
    ...
    <p class="card-text">View the car Bookings done by you.</p>
