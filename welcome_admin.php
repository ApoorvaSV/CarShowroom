...
<html lang="en">
  ...
  <div class="card-body my-2">
    <h5 class="card-title">Add or Remove cars</h5>
    <p class="card-text">Add or remove cars by clicking below.</p>
    <a href="add_removecars.php" class="btn btn-primary">Add/Remove cars</a>
  </div>
</div>
</div>
...
<div class="col-md-4">
  ...
  <div class="card-body my-2">
    <h5 class="card-title">View car Bookings</h5>
    <p class="card-text">View details of customers who have booked cars..</p>
    <a href="cust_bookings.php" class="btn btn-primary">View car Bookings</a>
  </div>
</div>
</div>
    </div>
